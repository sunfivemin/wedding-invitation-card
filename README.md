...
**Q: 모바일에서도 잘 보이나요?**  
A: 네! 모든 기기에서 최적화되어 보입니다.

**Q: 음악이 안 나와요**  
A: 브라우저 정책상 사용자가 직접 재생 버튼을 눌러야 합니다.

**Q: 정보를 어떻게 수정하나요?**  
A: 각 청첩장 페이지의 JavaScript 파일에서 정보를 수정하세요.

---

## 📞 문의 및 지원

- 🐛 **버그 신고**: [Issues](https://github.com/your-username/wedding-invitation-card/issues)
- 💬 **질문 및 토론**: [Discussions](https://github.com/your-username/wedding-invitation-card/discussions)
